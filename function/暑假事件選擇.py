...
def choose_summer_event(data):
    ...
    nextButton = tk.Button(data["status"].display, text = "繼續", relief = "raise", font = f, command = lambda: press_continue(data, background, nextButton, text))
...
def press_continue(data, background, nextButton, text):
    ...
    choose_button = []
    button1 = tk.Button(data["status"].display, text = "當兵", relief = "raise", font = f, command = lambda: choose(data, background, choose_button, "當兵"))
    button2 = tk.Button(data["status"].display, text = "打工", relief = "raise", font = f, command = lambda: choose(data, background, choose_button, "打工"))
    button3 = tk.Button(data["status"].display, text = "服務學習", relief = "raise", font = f, command = lambda: choose(data, background, choose_button, "服務學習"))
    button4 = tk.Button(data["status"].display, text = "陪另一半", relief = "raise", font = f, command = lambda: choose(data, background, choose_button, "陪另一半"))
    button5 = tk.Button(data["status"].display, text = "在家宅", relief = "raise", font = f, command = lambda: choose(data, background, choose_button, "在家宅"))
...
def choose(data, background, used_button , chosen):
    ...
    if chosen != "在家宅":
        ...
        button1 = tk.Button(data["status"].display, text = "耍廢", relief = "raise", font = f, command = lambda: home_choose(data, background, choose_button, "耍廢"))
        button2 = tk.Button(data["status"].display, text = "唸書", relief = "raise", font = f, command = lambda: home_choose(data, background, choose_button, "唸書"))
        button3 = tk.Button(data["status"].display, text = "規律作息", relief = "raise", font = f, command = lambda: home_choose(data, background, choose_button, "規律作息"))
        button4 = tk.Button(data["status"].display, text = "炒股", relief = "raise", font = f, command = lambda: home_choose(data, background, choose_button, "炒股"))
