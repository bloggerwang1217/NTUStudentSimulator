...
def load(window, data):
    ...
    data["status"] = status.Status(read_data[1][0], read_data[1][1], read_data[1][2], read_data[1][3], read_data[1][4], read_data[1][5], read.read_course("text/save.csv"), window)
